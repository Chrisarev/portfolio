...
let firstGuideButton = document.querySelector('#first-guide-button');
let secondPanel = document.getElementById('second-panel'); 
...
firstGuideButton.addEventListener('click',function() {
  secondPanel.scrollIntoView({ block:'end', behavior: 'smooth'});
})
